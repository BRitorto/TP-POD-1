...
import ar.edu.itba.pod.ClientCallbackInterface;
...
public class InspectorClient extends Client<InspectorService> implements ClientCallbackInterface {
    private Long id;
    private Party party;
    ...
    public void register(Long pollingPlaceId, Party party, ClientCallbackInterface callback) throws RemoteException {
